...
OLD_PLUGIN_PATH="${HOME}/.local/share/rhythmbox/plugins/rhythmbox-spectrum/"
PLUGIN_PATH="${HOME}/.local/share/rhythmbox/plugins/spectrum/"
GLIB_SCHEME="org.gnome.rhythmbox.plugins.spectrum.gschema.xml"
